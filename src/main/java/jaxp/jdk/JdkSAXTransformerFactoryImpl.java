 ...
 * @author rmartinc
 */
public class JdkSAXTransformerFactoryImpl extends SAXTransformerFactory {

    private final SAXTransformerFactory wrapped;

    public JdkSAXTransformerFactoryImpl() {
        wrapped = (SAXTransformerFactory) newDefaultInstance();
    }
    ...
    public TemplatesHandler newTemplatesHandler() throws TransformerConfigurationException {
        return wrapped.newTemplatesHandler();
    }

    @Override
    public TransformerHandler newTransformerHandler() throws TransformerConfigurationException {
        return wrapped.newTransformerHandler();
    }

    @Override
    public TransformerHandler newTransformerHandler(Source src) throws TransformerConfigurationException {
        return wrapped.newTransformerHandler(src);
    }

    @Override
    public TransformerHandler newTransformerHandler(Templates templates) throws TransformerConfigurationException {
        return wrapped.newTransformerHandler(templates);
    }

    @Override
    public XMLFilter newXMLFilter(Source src) throws TransformerConfigurationException {
        return wrapped.newXMLFilter(src);
    }

    @Override
    public XMLFilter newXMLFilter(Templates templates) throws TransformerConfigurationException {
        return wrapped.newXMLFilter(templates);
    }
